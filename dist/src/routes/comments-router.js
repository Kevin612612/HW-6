...
//(1) update comments
exports.commentsRouter.put('/:commentId', authorization_middleware_1.authorization, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //BLL
    const comment = yield comments_BLL_1.commentsBusinessLayer.updateCommentById(id, content);
    //RETURN
